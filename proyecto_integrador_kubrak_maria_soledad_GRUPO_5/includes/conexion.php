<?php class conexion{ # poner Conexion
    ...
    public function __construct(){
        ...
        try{ # manejo de excepciones, si el codigo esta adentro del try, esta controlado por el sistema
        ...
        }catch(PDOException $e){ # si algo del codigo del try falla, le mostramos un msj amigable al usuario del sistema
